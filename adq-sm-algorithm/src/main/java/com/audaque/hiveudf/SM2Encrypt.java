...
@Description(name = "sm2_encrypt", value = "SM2 Encrypt")
public class SM2Encrypt extends GenericUDF {
    ...
    public Object evaluate(final GenericUDF.DeferredObject[] arguments) throws HiveException {
        ...
        try {
            return new Text(SM2Utils.encryptKey64ResultBase64(privateKeyStr, encryptedData));
        } catch (Exception e) {
    ...
    public String getDisplayString(final String[] children) {
        return "sm2_encrypt(" + children[0] + ", " + children[1] + ")";
    }
}
