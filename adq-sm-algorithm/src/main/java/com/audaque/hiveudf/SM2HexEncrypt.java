...
@Description(name = "sm2_64encrypt", value = "SM2 Encrypt")
public class SM2HexEncrypt extends GenericUDF {
    ...
    public Object evaluate(final DeferredObject[] arguments) throws HiveException {
        ...
        try {
            return new Text(SM2Utils.encryptKeyHexResultHex(privateKeyStr, encryptedData));
        } catch (Exception e) {
    ...
    public String getDisplayString(final String[] children) {
        return "sm2_64encrypt(" + children[0] + ", " + children[1] + ")";
    }
}
