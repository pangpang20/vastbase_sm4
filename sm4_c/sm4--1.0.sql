...
'SM4 CBC模式加密(C扩展)，兼容gs_encrypt格式。参数: plaintext-明文, password-密码, hash_algo-哈希算法(sha256/sha384/sha512/sm3)。返回Base64编码的加密数据，格式与VastBase gs_encrypt兼容。包含版本号+算法标识+盐值+密文。';
...
'SM4 CBC模式解密(C扩展)，兼容gs_encrypt格式。参数: ciphertext-Base64编码的密文(gs_encrypt格式), password-密码。返回明文。自动识别哈希算法类型，可解密VastBase gs_encrypt加密的数据。';
